...
# /dataset/image/각 폴더명 생성/ 이미지 저장(resize 400 x 400)
# 직사각형에서 정사각형 리사이즈 비율 유지 하는 함수
...
def image_preprocessing(orange_data, grapefruit_data, kanpei_data, dekopon_data):
    orange = orange_data
...
if __name__ == "__main__":
    opt = parse_opt()
    orange_data, grapefruit_data, kanpei_data, dekopon_data = image_file_check(
        opt)
    image_preprocessing(orange_data, grapefruit_data, kanpei_data, dekopon_data)
